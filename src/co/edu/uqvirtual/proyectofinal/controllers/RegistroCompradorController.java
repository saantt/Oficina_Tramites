...
public class RegistroCompradorController {
    ...
    private void crearComprador() {
        ...
        if (validarDatos(nombre, ocupacion, estadoCivil, identificacion, direccion, celular, email, genero, usuario, password)) {
            if (verificarContraseña(password)) {
               mostrarMensaje("Notificación Comprador", "Contraseña Valida", "LA CONTRASEÑA CUMPLE CON LOS REQUISITOS",
                ...
                try {
                    comprador = crudRegistroViewController.crearComprador(nombre, ocupacion, estadoCivil, identificacion,
                            direccion, celular, email, genero, usuario, password,pregunta,respuesta);
                } catch (Exception e) {
                ...
                if (comprador != null) {
                    ...
                    mostrarMensaje("Notificación Comprador", "Comprador no creado",
